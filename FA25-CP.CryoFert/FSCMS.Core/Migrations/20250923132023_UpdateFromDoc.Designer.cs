...
namespace FSCMS.Core.Migrations
{
    ...
    [Migration("20250923132023_UpdateFromDoc")]
    partial class UpdateFromDoc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.CheckIn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.Commitment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.Contract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.Cryopreservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Cryoprotectant")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.EmbryoTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NumberOfEmbryos")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TreatmentTimelineId")
                        .HasColumnType("int");

                    b.Property<string>("UltrasoundGuided")
                        .HasColumnType("longtext");
                    ...
                    b.HasIndex("TreatmentTimelineId");

                    b.ToTable("EmbryoTransfers");
                });
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.InvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.LabTest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.MedicalHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.ServiceProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.TestResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.TestType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.Thawing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.EmbryoTransfer", b =>
                {
                    ...
                    b.HasOne("FSCMS.Core.Entities.TreatmentTimeline", "TreatmentTimeline")
                        .WithMany()
                        .HasForeignKey("TreatmentTimelineId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("TreatmentTimeline");
                });
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.InvoiceItem", b =>
                {
                    b.HasOne("FSCMS.Core.Entities.Invoice", "Invoice")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.LabTest", b =>
                {
                    b.HasOne("FSCMS.Core.Entities.User", "CollectedByUser")
                        .WithMany()
                        .HasForeignKey("CollectedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("FSCMS.Core.Entities.User", "OrderedByUser")
                        .WithMany()
                    ...
                    b.HasOne("FSCMS.Core.Entities.TestType", "TestType")
                        .WithMany()
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.Service", b =>
                {
                    b.HasOne("FSCMS.Core.Entities.ServiceProvider", "ServiceProvider")
                        .WithMany("Services")
            ...
            modelBuilder.Entity("FSCMS.Core.Entities.TestResult", b =>
                {
                    b.HasOne("FSCMS.Core.Entities.LabTest", "LabTest")
                        .WithOne("Result")
                        .HasForeignKey("FSCMS.Core.Entities.TestResult", "LabTestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FSCMS.Core.Entities.User", "VerifiedByUser")
                        .WithMany()
